...
product_name = 'XODOO'
description = 'XODOO Server'
long_desc = '''XODOO is a complete ERP and CRM. The main features are accounting (analytic
...
author = 'Amos S.A.'
author_email = '35350428@qq.com'
license = 'LGPL-3'

nt_service_name = "xodoo-server-" + series.replace('~','-')
