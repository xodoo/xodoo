...
class Home(http.Controller):
    ...
    def _get_menus(self, menus,debug_url):
        ...
        for line in root.get('children'):
            ...
            badge = menus.get(line).get('badge', '')
            if node1:
                node_html = ''
                ...
                limenus += menu1_children % (url, font_icon, badge,menus.get(line).get('name'), node_html)
                ...
                limenus += menu1 % (url, font_icon, badge,menus.get(line).get('name'))
    ...
    def _get_node1(self, node1, menus,debug_url):
        ...
        for line in node1:
            ...
            if node1:
                ...
                if url == False:
                    url = 'action-%s%s' % (menus.get(line).get('actionID'),debug_url)
                limenus += menu1 % (url, badge,font_icon, menus.get(line).get('name'))
