...
class Many2ManyTagsUrlFieldColorListPopover extends Component {
    static template = "web.Many2ManyTagsUrlFieldColorListPopover";
    static components = {
        CheckBox,
        ColorList,
    };
...
export class Many2ManyTagsUrlField extends Component {
    static template = "web.Many2ManyTagsUrlField";
    static components = {
        TagsList,
        Many2XAutocomplete,
    };
...
export const many2ManyTagsUrlField = {
    component: Many2ManyTagsUrlField,
    displayName: _t("Tags"),
    supportedOptions: [
        {
...
registry.category("fields").add("many2many_tags_url", many2ManyTagsUrlField);
// registry.category("fields").add("calendar.one2many", many2ManyTagsUrlField);
// registry.category("fields").add("calendar.many2many", many2ManyTagsUrlField);

/**
 * A specialization that allows to edit the color with the colorpicker.
 * Used in form view.
 */
export class Many2ManyTagsUrlFieldColorEditable extends Many2ManyTagsUrlField {
    static components = {
        ...super.components,
        Popover: Many2ManyTagsUrlFieldColorListPopover,
    };
    static props = {
        ...super.props,
...
export const many2ManyTagsUrlFieldColorEditable = {
    ...many2ManyTagsUrlField,
    component: Many2ManyTagsUrlFieldColorEditable,
    supportedOptions: [
        ...many2ManyTagsUrlField.supportedOptions,
        {
    ...
    extractProps({ options, attrs }) {
        const props = many2ManyTagsUrlField.extractProps(...arguments);
...
registry.category("fields").add("form.many2many_tags_url", many2ManyTagsUrlFieldColorEditable);
