...
export class CharUrlField extends Component {
    static template = "web.CharUrlField";
    static props = {
        ...standardFieldProps,
...
export const charUrlField = {
    component: CharUrlField,
...
registry.category("fields").add("char_url", charUrlField);

class FormCharUrlField extends CharUrlField {
    static template = "web.FormCharUrlField";
}

export const formCharUrlField = {
    ...charUrlField,
    component: FormCharUrlField,
};

registry.category("fields").add("form.char_url", formCharUrlField);
