(function ($) {
    ...
    function setLanguage(lang) {
        if (document.getElementById("header-lang-img")) {
            if (lang == 'en') {
                document.getElementById("header-lang-img").src = "/web/static/minia/assets/images/flags/us.jpg";
            } else if (lang == 'sp') {
                document.getElementById("header-lang-img").src = "/web/static/minia/assets/images/flags/spain.jpg";
            } else if (lang == 'gr') {
                document.getElementById("header-lang-img").src = "/web/static/minia/assets/images/flags/germany.jpg";
            } else if (lang == 'it') {
                document.getElementById("header-lang-img").src = "/web/static/minia/assets/images/flags/italy.jpg";
            } else if (lang == 'ru') {
                document.getElementById("header-lang-img").src = "/web/static/minia/assets/images/flags/russia.jpg";
            }
    ...
    function getLanguage() {
        ...
        $.getJSON('/web/static/minia/assets/lang/' + language + '.json', function (lang) {
            ...
            if ($(window).width() >= 992) {
                if (currentSIdebarSize == null) {
                    ...
                    try {
                        ...
                        var color = window.getComputedStyle(sidebarList).color;
                        if (color === "rgb(255, 255, 255)") {
                            sidebarList.style.color = '#5a4f7f';
                        } else {
                            sidebarList.style.color = '#FFFFFF';
                        }
    ...
    function layoutSetting() {
        ...
        $("input[name='layout-direction']").on('change', function () {
            if ($(this).val() == "ltr") {
                ...
                document.getElementById('bootstrap-style').setAttribute('href', '/web/static/minia/assets/css/bootstrap.min.css');
                document.getElementById('app-style').setAttribute('href', '/web/static/minia/assets/css/app.min.css');
            } else {
                document.getElementById('bootstrap-style').setAttribute('href', '/web/static/minia/assets/css/bootstrap-rtl.min.css');
                document.getElementById('app-style').setAttribute('href', '/web/static/minia/assets/css/app-rtl.min.css');
