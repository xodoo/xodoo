...
class print_web(http.Controller):
    ...
    @http.route(['/xodoo/ztree/hr_department'], type='http', auth="public", csrf=False)
    def xodoo_ztree_hr_department(self, **kw):
        """
        Tree
        :param post:
        :return:
        ...
        print(list)
        template = env.get_template('ztree/hr_department.html')
